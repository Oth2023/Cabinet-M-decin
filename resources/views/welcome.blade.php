        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary">Medcin</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="{{asset('assets/img/testimonial-1.jpg')}}" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="navbar-nav w-100">
                    <p href="index.html" class="nav-item nav-link active">My Cabinet</p>
...
>>>>>>> 82b0c598a0081948ed18a1d1b06155341c76139c
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Facture</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('factures.index')}}" class="dropdown-item">Liste  Consultation</a>
                            <a href="{{route('factures.create')}}" class="dropdown-item">Ajouter  Consultation</a>
                        </div>
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{asset('assets/img/testimonial-1.jpg')}}" alt="" style="width: 40px; height: 40px;">
